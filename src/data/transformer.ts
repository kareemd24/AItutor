...
export const transformer: ModuleDef = {
  ...
  items: [
...

    {
      ...
      note: 'Each position independently passes through a wide nonlinear transformation. “Geography? negation? code?” is a helpful feature metaphor; knowledge is distributed across embeddings, attention, FFNs, and their interactions.',
    },
    { id: 'tf.up', name: 'Up projection', kind: 'atom', parent: 'tf.ffn', zone: 'Feed-forward', x: 640, y: 130,
      note: 'The expansion step multiplies the vector into a wider hidden space. Roughly 4× is a classic rule of thumb, but modern gated architectures use several ratios.' },
    { id: 'tf.act', name: 'SwiGLU activation', kind: 'atom', parent: 'tf.ffn', zone: 'Feed-forward', x: 700, y: 210,
      note: 'SwiGLU multiplies a smooth SiLU branch by a learned gate. It modulates features continuously; unlike MoE routing, a dense SwiGLU layer does not select only a few neurons to run.' },
