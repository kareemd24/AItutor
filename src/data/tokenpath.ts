...
export const tokenpath: ModuleDef = {
  ...
  items: [
    ...
    { id: 'tp.embed', name: 'Embeddings', kind: 'atom', parent: 'tp.prompt', zone: 'Before the model', x: 160, y: 166, hitR: 55, ldy: 24,
      note: 'Each token ID indexes a giant lookup table: " France" becomes a vector of ~4,096 numbers. The payoff of vectors: similar meanings sit near each other — Paris next to France, banana far away.' },
